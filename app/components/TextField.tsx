...
export interface TextFieldProps extends Omit<TextInputProps, "ref"> {
   ...
   */
  status?: "error" | "disabled" | "filled" | "focused" | "default"
  /**
...
export const TextField = forwardRef(function TextField(props: TextFieldProps, ref: Ref<TextInput>) {
  ...
  const $inputWrapperStyles = [
    ...
    status === "filled" && { borderColor: colors.palette.success },
    status === "default" && { borderColor: colors.palette.neutral500 },
    status !== "default" && { borderWidth: 2 },
    isFocused && status === "default" && { borderColor: colors.palette.focus, borderWidth: 2 },
...
const $rightAccessoryStyle: ThemedStyle<ViewStyle> = ({ spacing }) => ({
  ...
  height: 56, // TODO: will add a prop with this value after align with Fahmi
