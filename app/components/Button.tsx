...
const $viewPresets: Record<Presets, ThemedStyleArray<ViewStyle>> = {
  ...
  filled: [
    $styles.row,
    $baseViewStyle,
    ({ colors }) => ({ backgroundColor: colors.palette.neutral500 }),
  ],
  reversed: [
    $styles.row,
    $baseViewStyle,
...
const $pressedViewPresets: Record<Presets, ThemedStyle<ViewStyle>> = {
  default: ({ colors }) => ({ backgroundColor: colors.palette.lightBlue }),
  outlined: ({ colors }) => ({ backgroundColor: colors.palette.lightBlue }),
